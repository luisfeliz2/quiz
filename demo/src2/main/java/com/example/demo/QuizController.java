...
public class QuizController {
	@GetMapping("")
	public String inicio(Model demo.model, HttpSession sesion) {
	...
	public String pregunta3(Model demo.model) {
		return "pregunta3";
	...
	public String pregunta4(Model demo.model) {
		return "pregunta4";
	}
	...
	private String determinarCategoria(int puntuacion, Model demo.model) {
